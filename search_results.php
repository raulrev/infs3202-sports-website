        ...
        <div class="row content">
            ...
            <div id= "TopNews" class="col-sm-8 text-left">
                ...
                <div class="row" id="top-group-container" style="margin-left:5px; margin-right:5px;">                    
                    ...
                    <hr>
                    <div class="carousel slide" id="myCarousel" style="margin-left:0px;" >
                        <div class="carousel-inner">
                            <?php echo searchFootballSources() ?>
							<?php echo searchNFLSources() ?>
							<?php echo searchBCCSources()?>
							<?php echo searchSBibleSources()?>
							<?php echo searchFOXSources()?>
							<?php echo searchESPNSources()?>
